...
//                 return a ? layui.addcss("modules/layer/default/layer.css?v=" + r.v + i, e, t) : r.link("js/layer.css?v=" + r.v + i, e, t), this
...
function search() {
    ...
    var hotList = 0;
    var searchData = {
        "thisSearch": "/typecho/search/",
        "thisSearchIcon": "url('/typecho/usr/themes/WebStack_ICEFOX/images/home-search.png')",
        "hotStatus": true,
        "data": [{
            name: "站内",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/home-search.png')0px 0px; background-repeat: no-repeat;background-size: 100%;opacity: 1;width: 22px;height: 22px;margin-top:3px;",
            position: "0px 0px",
            url: "/link/search/"
        }, {
            name: "百度",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -80px 0px",
            position: "0px 0px",
            url: "https://www.baidu.com/s?wd="
        }, {
            name: "谷歌",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png')  -105px 0px",
            position: "-40px 0px",
            url: "https://www.google.com/search?q="
        }, {
            name: "必应",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png')  -80px -25px",
            position: "0px -40px",
            url: "https://cn.bing.com/search?q="
        }, {
            name: "好搜",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -105px -25px",
            position: "-40px -40px",
            url: "https://www.so.com/s?q="
        }, {
            name: "搜狗",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -80px -50px",
            position: "0px -80px",
            url: "https://www.sogou.com/web?query="
        }, {
            name: "淘宝",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -105px -50px",
            position: "-40px -80px",
            url: "https://s.taobao.com/search?q="
        }, {
            name: "京东",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -80px -75px",
            position: "0px -120px",
            url: "http://search.jd.com/Search?keyword="
        }, {
            name: "天猫",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -105px -75px",
            position: "-40px -120px",
            url: "https://list.tmall.com/search_product.htm?q="
        }, {
            name: "1688",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -80px -100px",
            position: "0px -160px",
            url: "https://s.1688.com/selloffer/offer_search.htm?keywords="
        }, {
            name: "知乎",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -105px -100px",
            position: "-40px -160px",
            url: "https://www.zhihu.com/search?type=content&q="
        }, {
            name: "微博",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -80px -125px",
            position: "0px -200px",
            url: "https://s.weibo.com/weibo/"
        }, {
            name: "B站",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -105px -125px",
            position: "-40px -200px",
            url: "http://search.bilibili.com/all?keyword="
        }, {
            name: "优酷",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -105px -150px",
            position: "-40px -240px",
            url: "https://so.youku.com/search_video/q_"
        }, {
            name: "GitHub",
            img: "url('/typecho/usr/themes/WebStack_ICEFOX/images/search_icon.png') -80px -175px",
            position: "0px -280px",
    ...
    function filterChildren(element) {
        // thisText = $(element).find(".sa_tm span").contents().filter(function (index, content) {
            // return content.nodeType === 1
        // }).text().trim();
        var thisText = $(element).find(".sa_tm strong").contents().text().trim();
        if (thisText === ''){
            thisText = $(element).find(".sa_tm span").contents().text().trim();
        }
        return thisText
    }
    ...
    function getHotkeyword(value) {
        $.ajax({
            ...
            url: "https://web.yaonas.space/html_project/DouBan/api2.php",
            async: true,
            // data: {wd: value},
            data: {msg: value},
            dataType: "json",
            ...
            success: function (res) {
                ...
                hotList = res.Info.length;
                if (hotList) {
                    $("#box").css("display", "block");
                    for (var i = 0; i < hotList; i++) {
                        // $("#box ul").append("<li><span>" + (i + 1) + "</span> " + res.s[i] + "</li>");

                        var title_value = res.Info[i]['title']==null ? "<span>"+res.Info[i]['other-title']+"</span>":"<strong>"+res.Info[i]['title']+"</strong>";
                        var description_value = res.Info[i]['description']==null ? '' : "<p>"+res.Info[i]['description']+"</p>";
                        var img_value = res.Info[i]['img']==null ? '<div class="ciso"><svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1496" width="40" height="40"><path d="M950.4 905.6l-236.8-236.8c54.4-64 86.4-147.2 86.4-236.8C800 227.2 636.8 64 432 64 227.2 64 64 227.2 64 432 64 636.8 227.2 800 432 800c89.6 0 172.8-32 236.8-86.4l236.8 236.8c6.4 6.4 16 9.6 22.4 9.6s16-3.2 22.4-9.6C963.2 937.6 963.2 918.4 950.4 905.6zM432 736C265.6 736 128 598.4 128 432 128 265.6 265.6 128 432 128c166.4 0 304 137.6 304 304C736 598.4 598.4 736 432 736z" p-id="1497" fill="#999"></path></svg></div>' : "<div class='ciso'><img src="+res.Info[i]['img']+" width='40' height='40'></div>";
                        
                        $("#box ul").append("<li><div class='suggestion'><span class='index_num'>" + (i + 1) + "</span> " + img_value + "<div class='sa_tm'>"+title_value + description_value +"</div></div></li>");
                        ...
                        if (i === 0) {
                            ...
                            $("#box ul span.index_num").eq(i).css({"color": "#fff", "background": "#f54545"})
                        } else {
                            if (i === 1) {
                                $("#box ul span.index_num").eq(i).css({"color": "#fff", "background": "#ff8547"})
                            } else {
                                if (i === 2) {
                                    $("#box ul span.index_num").eq(i).css({"color": "#fff", "background": "#ffac38"})
                                }
                            }
                        }
                    }
