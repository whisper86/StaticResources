 ...
 * 点击Toggle互动
 */
function clickToggleHudong() {
    $(".text-gray").off('click');
    $(".text-gray").on('click', function (e) {
...
function clickShowmore() {
    ...
    $(".show_IMG").on('click', function (e) {
        let showIMGElement = e.target;
        $("div.need-hide").toggle();

        if ($("p.ShowIMAGE-info").text() == "Show More") {
            $("p.ShowIMAGE-info").text("Fold");
        } else if ($("p.ShowIMAGE-info").text() == "Fold") {
            $("p.ShowIMAGE-info").text("Show More");
        }
    });
}
...
function scrollToTop() {
    if (document.querySelector("aside.sidebar-menu-inner").scrollTop !== 0 || document.documentElement.scrollTop !== 0) {
        document.querySelector("aside.sidebar-menu-inner").scrollBy(0, -50);
...
function printCopyright() {
    console.log('%cIcefox&WebStack主题 By XuYao v1.0.0 %chttps://github.com/whisper86', 'color: white;  background-color: #99cc99; padding: 10px;', 'color: white; background-color: #ff6666; padding: 10px;');
}
